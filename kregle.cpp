...
unsigned int check (unsigned int xthrow);
...

 {
						...
						if (i>1)							//naliczanie premii po drugim  rzucie
							...
							bonus[p]=1;
								...
								oframe = throw1 + throw2;
									if (oframe >=10)
										{
											cout<< "suma punktow z dwoch rzutow nie moze byc wieksza niz 10, zacznij od nowa";
											goto begin;
										}
									else
		 								{
	 ...
	 /*				for (see = bonus.begin()+1; see !=bonus.end(); ++see) 
				{
	 ...
	 */
...

	 {
		 ...
		 {	
			 ...
			 cout<<"nie umiesz BUCU policzyć do 10 \n sprobuj policzyć jeszcze raz wykorzystujac reszte mozgu \n";
			 cin>> xthrow;
